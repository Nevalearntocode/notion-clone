...
import { DocumentListProps } from "@/types/main"
...
const DocumentList = ({parentDocumentId, level=0}:DocumentListProps) => {
  ...
  return (
    <>
      <p style={{paddingLeft: level ? `${(level*12)+25}px` : undefined}} className={cn("hidden text-sm text-muted-foreground/80 font-medium", expanded && "last:block", level === 0 && "hidden")}>
        No page inside
      </p>
