...
import { PublishProps } from '@/types/main'
        ...
        {initialData.isPublished ? (
          <div className='space-y-4'>
            ...
            <div className='flex items-center'>
              <input value={url} className='flex-1 px-2 border rounded-l-md h-8 bg-muted truncate' disabled />
          ...
          <div className='flex flex-col items-center justify-center'>
            ...
            <Button disabled={isSubmitting} onClick={onPublish} className='text-xs w-full' size={`sm`}>
              Publish
            </Button>
          </div>
        )}
