...
import { Spinner } from '@/app/(marketing)/_components'
    ...
    <div className='text-sm'>
      ...
      <div className='mt-2 px-1 pb-1'>
        ...
        {filteredDocuments?.map((document) => (
          <div key={document._id} role='button' onClick={() => onClick(document._id)} className='text-sm rounded-sm w-full hover:bg-primary/5 text-primary items-center justify-between flex'>
